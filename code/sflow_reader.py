...
data_toxr = full_data.set_index(['time','lat','lon'])
#for the pandas dataframe we can just set the index to be time
data_topd = full_data.set_index('time')
